...
class LedState(metaclass=Metaclass_LedState):
    ...
    def __init__(self, **kwargs):
        ...
        self.led_1 = kwargs.get('led_1', bool())
        self.led_2 = kwargs.get('led_2', bool())
        self.led_3 = kwargs.get('led_3', bool())
    ...
    def led_1(self, value):
        if __debug__:
            assert \
                ...
                "The 'led_1' field must be of type 'bool'"
        self._led_1 = value
    ...
    def led_2(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'led_2' field must be of type 'bool'"
        self._led_2 = value
    ...
    def led_3(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'led_3' field must be of type 'bool'"
        self._led_3 = value
